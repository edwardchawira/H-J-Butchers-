...
export const products: Product[] = [
  ...
  make("c1", "Chicken Breast Fillets 550g", "chicken", 4.35, "550g", "Plump, succulent chicken breast fillets with delicate flavour.", { featured: true, images: ["/images/chicken-breast-fillets-550g-product.png"], tags: ["Free Range", "High protein"], weightOptions: ["550g"], nutritionalInfo: { calories: 120, protein: 26, fat: 2, carbs: 0 } }),
  ...
  make("c3", "Whole Corn-fed Chicken", "chicken", 8.5, "Each", "A whole corn-fed chicken with rich flavour, ready for roasting.", { images: ["/images/whole-corn-fed-chicken-product.png"], newArrival: true, tags: ["Corn-fed", "Roast ready"], nutritionalInfo: null, weightOptions: ["Each"] }),
  make("c4", "Chicken Wings 1kg", "chicken", 3, "1kg", "Tender chicken wings ready for roasting, grilling or marinating.", { images: ["/images/chicken-wings-1kg-product.png"], newArrival: true, tags: ["Chicken wings", "Grill ready"], nutritionalInfo: null, weightOptions: ["1kg"] }),
  make("c5", "Chicken Drumsticks 1kg", "chicken", 2.65, "1kg", "Meaty chicken drumsticks ready for roasting, grilling or marinating.", { images: ["/images/chicken-drumsticks-1kg-product.png"], newArrival: true, tags: ["Chicken drumsticks", "Grill ready"], nutritionalInfo: null, weightOptions: ["1kg"] }),
  make("c6", "Chicken Legs 2kg", "chicken", 4.45, "2kg", "Juicy chicken legs ready for roasting, grilling or slow cooking.", { images: ["/images/chicken-legs-2kg-product.png"], newArrival: true, tags: ["Chicken legs", "Roast ready"], nutritionalInfo: null, weightOptions: ["2kg"] }),
  ...
  make("q2", "Butcher's BBQ Feast Box", "bbq", 49.95, "Serves 6", "Burgers, sausages, skewers and ribs curated for the grill.", { featured: true, images: ["/images/butchers-bbq-feast-box-product.png"], weightOptions: ["Serves 6", "Serves 10"], rating: 4.9, reviewCount: 108 }),
